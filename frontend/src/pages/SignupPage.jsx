...
const SignupPage = () => {
  ...
  // --- Independent States for Password Toggles ---
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                name="password"
                className="w-full px-3 py-2 text-gray-900 bg-gray-50 border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 pr-10"
                placeholder="••••••••"
